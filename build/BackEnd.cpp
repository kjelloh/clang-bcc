...
namespace BackEnd {
	...
	namespace detail {
		...
		std::runtime_error runtime_exception_of_api_error_code(const std::string sPrefix, API_ERROR_CODE api_error_code) {
			static_assert(false, "runtime_exception_of_api_error_code_impl not implemented for this platform");
		}
	...
	namespace process {
		...
		public:
			Process(const Path& cmd, const Parameters& parameters) {
				static_assert(false, "class Process not implemented for this platform");
			}
